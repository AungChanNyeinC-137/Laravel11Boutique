              ...
              <ul class="list list-inline mb-0">
                ...
                <li class="list-item">
                  <span class="menu-link py-1">
                    <input type="checkbox" name="categories" id="" class="chk-category" value="{{$category->id}}"
                      @if (in_array($category->id,explode(',',$filter_categories)))
                    checked = "checked"
                    @endif>
                    {{$category->name}}
                  </span>
                  <span class="text-rigth float-end text-muted">{{$category->products->count()}}</span>
                </li>
                @endforeach
              </ul>
            </div>
        ...
        <div class="accordion-item mb-4">
          ...
          <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
            ...
            <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1"
              data-slider-max="1000000" data-slider-step="5" data-slider-value="[{{$min_price}},{{$max_price}}]" data-currency="Ks" />
            <div class="price-range__info d-flex align-items-center mt-2">
              <div class="me-auto">
                <span class="text-secondary">Min Price: </span>
                <span class="price-range__min">1Ks</span>
              </div>
              <div>
                <span class="text-secondary">Max Price: </span>
                <span class="price-range__max">1000000Ks</span>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    <a href="{{route('shop.product.details',['product_slug'=>$product->slug])}}"><img loading="lazy" src="{{asset('uploads/products')}}/{{$gimage}}"
                        width="330" height="400" alt="" class="pc__img"></a>
                  </div>
                  @endforeach
                </div>
            ...
            <div class="pc__info position-relative">
              ...
              <div class="product-card__price d-flex">
                <span class="money price">
                  ...
                  <s>{{$product->regular_price}}Ks</s>{{$product->sale_price}}Ks
                  @else
                  {{$product->regular_price}}Ks
                  @endif
                </span>
              </div>
              ...
              <form action="{{route('wishlist.item.remove',['row_id'=>Cart::instance('wishlist')->content()->where('id',$product->id)->first()->rowId])}}" method="post">
                @csrf
                @method('DELETE')
...
<form action="{{route('shop.index')}}" id="frmfiler" method="get">
  @csrf
