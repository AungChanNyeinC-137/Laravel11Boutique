...
<div class="main-content-inner">
    ...
    <div class="main-content-wrap">
        ...
        <!-- new-category -->
        <div class="wg-box">
            <form action="{{ route('admin.slide.update',$slide->id) }}" class="form-new-product form-style-1" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                //<input type="hidden" name="id" id="slide_id" value="{{$slide->id}}">
                <fieldset class="name">
                    ...
                    <div class="select flex-grow">
                        <select class="" name="status">
                            ...
                            <option value="1"
                                @if ($slide->status =='1' )
                                selected
                                @endif class="text text-success">Active</option>
                            <option value="0"
                                @if ($slide->status =='0' )
                                selected
                                @endif class="text text-danger">Inactive</option>
                        </select>
                    </div>
                </fieldset>
                <div class="bot">
