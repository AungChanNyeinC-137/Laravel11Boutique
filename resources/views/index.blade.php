...
<div class="container mw-1620 bg-white border-radius-10">
  ...
  <section class="category-carousel container">
    <h2 class="section-title text-center mb-3 pb-xl-2 mb-xl-4">You Might Also Like</h2>
    ...
    <div class="position-relative">
      <div class="swiper-container js-swiper-slider" data-settings='{
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <img loading="lazy" class="rounded-circle w-100 h-auto mb-3" src="{{asset('uploads/categories')}}/{{$category->image}}" width="124"
      ...
      <div class="col-md-6 col-lg-8 col-xl-80per">
        <div class="position-relative">
          <div class="swiper-container js-swiper-slider" data-settings='{
            ...
            <div class="swiper-wrapper">
              @foreach ($sale_prodcuts as $spd)
              <div class="swiper-slide product-card product-card_style3">
                <div class="pc__img-wrapper">
                  <a href="{{route('shop.product.details',['product_slug'=>$spd->slug])}}">
                    <img loading="lazy" src="{{asset('uploads/products') }}/{{$spd->image}}" width="258" height="313"
                      alt="{{$spd->name}}" class="pc__img">
                  </a>
                </div>

                <div class="pc__info position-relative">
                  <h6 class="pc__title"><a href="details.html">{{$spd->name}}</a></h6>
                  <div class="product-card__price d-flex">
                    @if($spd->sale_price)
                    <s class="money price text-secondary">{{$spd->regular_price}}Ks</s><span class="money price text-secondary">{{$spd->sale_price}}Ks</span>
                    @else
                    <span class="money price text-secondary">{{$spd->regular_price}}Ks</span>
                    @endif
  ...
  <section class="products-grid container">
    ...
    <div class="row">
      @foreach ($featured_products as $fpd)
      <div class="col-6 col-md-4 col-lg-3">
        <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
          <div class="pc__img-wrapper">
            <a href="{{route('shop.product.details',['product_slug'=>$fpd->slug])}}">
              <img loading="lazy" src="{{asset('uploads/products')}}/{{$fpd->image}}" width="330" height="400"
                alt="Cropped Faux leather Jacket" class="pc__img">
            </a>
          </div>

          <div class="pc__info position-relative">
            <h6 class="pc__title"><a href="{{route('shop.product.details',['product_slug'=>$fpd->slug])}}">{{$fpd->name}}</a></h6>
            <div class="product-card__price d-flex align-items-center">
            @if($fpd->sale_price)
                    <s class="money price text-secondary">{{$fpd->regular_price}}Ks</s><span class="money price text-secondary">{{$fpd->sale_price}}Ks</span>
                    @else
                    <span class="money price text-secondary">{{$fpd->regular_price}}Ks</span>
                    @endif
            </div>
