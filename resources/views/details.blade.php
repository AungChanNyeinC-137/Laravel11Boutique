    ...
    <div class="row">
      ...
      <div class="col-lg-5">
        ...
        <div class="product-single__addtolinks">
          ...
          <form action="{{route('wishlist.item.remove',['row_id'=>Cart::instance('wishlist')->content()->where('id',$product->id)->first()->rowId])}}"
            id="frm-wishlist-remove" method="post">
            @csrf
            @method('DELETE')
            <a href="javascript:void(0)" onclick="document.getElementById('frm-wishlist-remove').submit();" class="menu-link menu-link_us-s add-to-wishlist "><svg width="16" height="16" viewBox="0 0 20 20"
                fill="none" xmlns="http://www.w3.org/2000/svg" class="filled-heart">
                <use href="#icon_heart" />
              </svg>
            ...
            <div class="pc__img-wrapper">
              <a href="{{route('shop.product.details',['product_slug'=>$related_product->slug])}}">
                ...
                <img loading="lazy" src="{{asset('uploads/products')}}/{{$gimg}}" width="330" height="400"
                  alt="" class="pc__img pc__img-second">
                @endforeach
                @endif
              </a>
              <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
            ...
            <div class="pc__info position-relative">
              ...
              <div class="product-card__price d-flex">
                <span class="money price">
                  ...
                  <s>{{$related_product->regular_price}}Ks</s>{{$related_product->sale_price}}Ks
                  @else
                  {{$related_product->regular_price}}Ks
                  @endif
                </span>
              </div>
